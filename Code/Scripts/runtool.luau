...
local tool = Instance.new("Tool")
    ...
    local movementSpeed = 125 -- Change this to adjust movement speed

    local animation = Instance.new("Animation")
    animation.AnimationId = "rbxassetid://87314883530459" --Not working 
    ...
    tool.Equipped:Connect(function()
        ...
        for i, v in character:GetChildren() do
            if v:IsA("Part") then
                ...
                ParticleEmitter.Texture = [[nil]] --put the texture here
